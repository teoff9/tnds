...
VectorField::VectorField(const Point3D pos) : f_x{0}, f_y{0}, f_z{0}, Point3D{pos} {}
VectorField::VectorField(const Point3D pos, double Fx, double Fy, double Fz) : f_x{Fx}, f_y{Fy}, f_z{Fz}, Point3D{pos}{}
...
//methods
double VectorField::get_fx() const {
    return f_x;
}
double VectorField::get_fy() const{
    return f_y;
}
double VectorField::get_fz() const {
    return f_z;
}
...
void VectorField::set_fx(double new_fx) {
    f_x = new_fx;
}
void VectorField::set_fy(double new_fy) {
    f_y = new_fy;
}
void VectorField::set_fz(double new_fz) {
    f_z = new_fz;
}