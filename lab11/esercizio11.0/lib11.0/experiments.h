...
//Init
Prism::Prism(unsigned int seed) : gen{seed}, alpha{M_PI/3.}, lambda1{579.1}, 
    lambda2{404.7}, sigma_t{0.3e-3}, A_i{2.7}, B_i{60000} 
{
...
void Prism::analyze() {
    ...
    A_m =  (pow(lambda2*n2_m,2) - pow(lambda1*n1_m, 2)) / (pow(lambda2,2) - pow(lambda1,2));
