...
// successivamente eseguire 'make histograms' per generare i png degli istogrammi
...
int main() {
    ...
    for (int k{}; k<2; k++) {
        ...
        for (int i{}; i<6; i++) {
            ...
            out.close();
            cout << format(" => N={} DONE, created : {}", cases[i], file_name) << endl;
        }
        delete m;
    }

    cout << "\n => All files generated: type 'make histo' to generate the png(s)\n";
