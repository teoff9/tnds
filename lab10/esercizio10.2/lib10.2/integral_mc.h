...
class IntegralMC {
    public:
        ...
        virtual double integrate(function<double (double)> f, double inf, double sup, int N, double f_max) = 0;
...
class MC_mean : public IntegralMC {
    public:
        ...
        virtual double integrate(function<double (double)> f, double inf, double sup, int N, double f_max) override {
            double f_i{};
            for (int i{}; i < N; i++) {
