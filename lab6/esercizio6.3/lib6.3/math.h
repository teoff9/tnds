...
public:
  ...
  virtual double find_root(Function &f, double x_min, double x_max,
...
public:
  ...
  double find_root(Function &f, double x_min, double x_max, double _prec,
                   int _n_max) override;
};

double Bisection::find_root(Function &f, double x_min, double x_max,
