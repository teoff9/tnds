...
public:
  ...
  virtual double find_root(function<double(double)> f, double x_min, double x_max,
                           double _prec, int _n_max) = 0;
...
public:
  ...
  double find_root(function<double(double)> f, double x_min, double x_max, double _prec,
                   int _n_max) override;
};

double Bisection::find_root(function<double(double)> f, double x_min, double x_max,
                            double _prec = 1e-3, int _n_max = 100) {
